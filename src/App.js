             ...
             "restaurants": [
                      {
                          "info": {
                              ...
                              "availability": {
                                  "nextCloseTime": "2024-05-23 22:59:00",
                                  "opened": true
                              },
                              "badges": {},
                              "isOpen": true,
                      ...
                      },
                      {
                          "info": {
                              ...
                              "availability": {
                                  "nextCloseTime": "2024-05-23 23:58:00",
                                  "opened": true
                              },
                              "badges": {
                                  "imageBadges": [
                      ...
                      },
                      {
                          "info": {
                              ...
                              "availability": {
                                  "nextCloseTime": "2024-05-24 00:45:00",
                                  "opened": true
                              },
                              "badges": {
                                  "imageBadges": [
                      ...
                      },
                      {
                          "info": {
                              ...
                              "availability": {
                                  "nextCloseTime": "2024-05-23 22:00:00",
                                  "opened": true
                              },
                              "badges": {
                                  "imageBadges": [
...
const Header=()=>{
  return (
    <div className="header">
      ...
      <div id="logo">
        <img id="image" src="https://www.team2.asia/wp-content/uploads/Foodbuzz-Logo-2.jpg"></img>
      </div>
...
const RestaurantCard=(props)=>{
  return(
    <div className="res-card">
      <img className="res-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+props.image_id} />
      <h3>{props.resName}</h3>
    </div>
  )
}
  ...
  return(
    <div className="body">
      ...
      <div className="res-container">
        {
          resData.restaurants.map(restaurant=><RestaurantCard resName={restaurant.info.name} image_id={restaurant.info.cloudinaryImageId}/>)
        }
     </div>
